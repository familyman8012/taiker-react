              ...
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="single-projects-box">
                  ...
                  <div className="projects-content">
                    ...
                    <span className="category">심리상담</span>
                  </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="single-projects-box">
                  ...
                  <div className="projects-content">
                    ...
                    <span className="category">법무법인</span>
                  </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="single-projects-box">
                  ...
                  <div className="projects-content">
                    ...
                    <span className="category">유치원</span>
                  </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="single-projects-box">
                  ...
                  <div className="projects-content">
                    ...
                    <span className="category">헬스장</span>
                  </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="single-projects-box">
                  ...
                  <div className="projects-content">
                    ...
                    <span className="category">연애상담</span>
                  </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="single-projects-box">
                  ...
                  <div className="projects-content">
                    ...
                    <span className="category">홈쇼핑</span>
                  </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="single-projects-box">
                  ...
                  <div className="projects-content">
                    ...
                    <span className="category">인테리어</span>
                  </div>
