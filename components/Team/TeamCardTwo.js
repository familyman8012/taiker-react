                    ...
                    <div className="container-fluid max-w-1700">
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-team-box">
                                    <div className="image">
                                        <img src="/images/team-image/team4.jpg" alt="team" />
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-team-box">
                                    <div className="image">
                                        <img src="/images/team-image/team5.jpg" alt="team" />
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-team-box">
                                    <div className="image">
                                        <img src="/images/team-image/team6.jpg" alt="team" />
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-team-box">
                                    <div className="image">
                                        <img src="/images/team-image/team7.jpg" alt="team" />
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-team-box">
                                    <div className="image">
                                        <img src="/images/team-image/team8.jpg" alt="team" />
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-team-box">
                                    <div className="image">
                                        <img src="/images/team-image/team9.jpg" alt="team" />
